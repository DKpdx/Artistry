            ...
            <div className="offset-3 col-6">
                <div className="shadow p-4 mt-4">
                    ...
                    <form id="update-art-form" onSubmit={handleSubmit}>
                        ...
                        <div className="form-floating mb-3">
                            <input onChange={handleCategoryChange} placeholder="Category" required type="text" name="category" id="category" className="form-control" value={category}/>
                            <label htmlFor="category">Category</label>
                        </div>
                        <div className="form-floating mb-3">
                            <input onChange={handleArtPictureChange} placeholder="Art Picture" required type="text" name="art_picture" id="art_picture" className="form-control" value={artPicture}/>
